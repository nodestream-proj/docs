...
Nodestream has a number of extractors built in and you can also [create your own](../tutorials-advanced/building-new-processing-steps.md#creating-a-new-extractor).
